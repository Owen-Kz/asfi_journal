        ...
        <div class="main-submit-container">
            ...
            <div class="submit-container">
                <div class="submit-body" style="margin: 0 8px 0 8px;">
					...
					<p>Peer review is antegralgredient the scientific process, culminating the publication of articles for the consumption of fellow scientists or otherterested stakeholders society. For this reason, all papers submitted to <i>ASFIRJ</i> must undergo a thorough peer-review process which expert peers the topic area of respective submitted manuscripts arevited to provide critical assessment of the submitted manuscripts. The feedback received from thevited peers is criticalforming the editors’ decision on any submitted manuscript. The peer review process thus ensures that all submissions to <i>ASFIRJ</i> attain the highest expected standard of rigor, excellence, and scientific quality. <br> <br> 
						
						Any submission to <i>ASFIRJ</i> first undergoes a thorough check by the editorial assistance to ensure <i>ASFIRJ</i>-house formatting and requirements are adhered to. Any manuscript that does not meet the required formatting is returned to the authors for amendment and re-submission. <br> <br> 
						Once the formatting checks are successful, the manuscript is passed to a sectional or an associate editor, as the case may be, who then assesses the scientific content of the manuscript to ensure that it meets possible publication <i>ASFIRJ</i>. If the manuscript is judged by the handling editor to be potentially suitable for publication <i>ASFIRJ</i>, the handling editor appoints suitable peer reviewers to review the manuscript and make acceptance recommendation to the handling editor. <br> The handling editor, on the basis of the recommendations from thevited peer reviewers, makes a decision. Reports from at least two peer reviewers are required to make an editorial decision on any manuscript sent out for peer review. <span id="2"></span> Upon acceptance, manuscripts undergo copy-editing by the team of editorial assistance, after which the article is published an issue on ASFIRJ website. Authors areformed once the manuscript is published online. </p>
					
					<h4>Your Role as a Reviewer for ASFIRJ:</h4>
					<p>As a peer reviewer, your role is crucial ensuring the highest scientific quality of articles published ASFIRJ. The review process confers on the peer reviewer a professional responsibility through which s/he contributes to the scientific community by using their skills to enhance the quality and standard of scientific publications. As a reviewer, you are expected to perform your task timely, transparently, and an ethical manner. The Committee on Publication Ethics (COPE) outlines various ethical standards the reviewer should be aware of and adhere to. Details are available at: <a href="https://publicationethics.org/files/cope-ethical-guidelines-peer-reviewers-v2_0.pdf" style="color: blueviolet;">Ethical guidelines for peer reviewers - COPE (publicationethics.org)</a>. <br> <br>
						To ensure the scientifictegrity of submissions to the journal, it is important that reviewersvited to review manuscripts for ASFIRJ have sufficient time to perform the assigned task and submit their report within the requested time. We understand that reviewers usually have many professional tasks being performed parallel, potentially conflicting with other tasks, causing reviewers often not to meet the deadline required to submit their review reports. In that case, the editors will appreciate that reviewers communicate their situation and anyability to submit their review reports within the specified timeframe. <br>
						
						<ul style="margin-top: -16px;">
							To be eligible to review a paper for <i>ASFIRJ</i>, the reviewers should meet the following criteria:
							<li>Absence of any conflicts ofterest relation to the submitted manuscript or with any of the authors.</li>
							<li>Not have published together with the authors the last two years. <span id="3"></span></li>
							<li>Has relevant experiences the field of the submitted paper to judge the scientific quality.</li>
						</ul>
					...
					<p>ASFIRJ values the crucial work done by its reviewers and to show our appreciation of their contribution, reviewers for the journal are entitled to the following benefits: 
						<ul style="margin-top: -16px;">
							...
							<li><b>Annual Reviewer Acknowledgement:</b> <span id="4"></span> Reviewers within a calendar year arecluded the journal’s annual reviewer acknowledgment list published an issue the immediate subsequent year.</li>
						</ul>
					</p>
					
					<h4>Single Blind Peer Review and Confidentiality </h4>
					<p>ASFIRJ operates a single-blind peer review system which case the authors do not know the identity of the reviewers of their manuscript, but the reviewers will know the identity of the authors. Until the article is published, reviewers should keep the content of the manuscript confidential. <span id="5"></span> Reviewers must ensure not to reveal their identity to the authors when commenting the submitted manuscript.</p>
					
					
					
						<h4>Reviewer’s Report</h4>
						<p>It is the duty of reviewers to provide a critical assessment of any manuscript they arevited to review. The reviewer’s assessment must meet the highest standard of quality expected of a scientific paper. Reviewers’ assessment must be guided by the scientific content of every submission rather than trivial errors grammar or formatting. While the reviewer must pay close attention to ensure that the writing of the manuscript meets minimum standards of a scientific communication, the critical assessment of the scientific content of the manuscript is more important and must be given priority. <br>
							

							<ul style="margin-top: -16px;">
								The peer review report must be written English. As a guide, wevite reviewers to consider the following recommendations when evaluating a manuscript for <i>ASFIRJ</i>.
								<li>Please read all sections of the manuscript,cluding abstract, main text, supplementary material (if provided) to ensure that you are acquainted with the content of the manuscript. Please also pay careful attention to the figures, tables, data, and correctness of language used the manuscript.</li>
								<li>Ensure that you provide a critical synopsis of the whole manuscript and at the same time comment on the different sections and field-specific concepts presented the manuscript.</li>
								...
								<li><i>ASFIRJ</i> does not accept the use of artificialtelligence (AI) or AI-assisted tools (such as ChatGPT) for peer review of submitted manuscripts and generating the peer review report. It is the sole responsibility of reviewers on the content of their review reports. The use of AI technologies the peer review process constitutes a breach of peer review confidentiality.</li>
								<li><i>ASFIRJ</i> adheres to established scientific publication standards and guidelines,cluding those from the ICMJE (medical journals), CONSORT (trial reporting), STROBE (observational studies), PRISMA (systematic reviews and meta-analyses) and other guidelines recommended by the EQUATOR network <a href="https://www.equator-network.org/" style="color: blueviolet;">(https://www.equator-network.org/)</a>, TOP (data transparency and openness), and ARRIVE (reporting of vivo experiments). Reviewers should report any deviations or concerns they observe regarding these guidelines.</li>
						...
						<p>Reviewers can outline their review reports the following structure: 
							<ul style="margin-top: -26px;">
								...
								<li><b>General comments:</b> Reviewers should provide general comments that highlight the scientific content of the manuscript,cluding relevance of the topic to the field; appropriateness of the approaches and study design used to address the topic; validity and reliability of employed methods,cluding measurementstruments; areas of weakness; the appropriateness of references used; any ethical issues; etc. Reviewers’ comments should be sufficiently specific to enable the authors to respond and address the concerns appropriately.</li>
					...
					<p>Reviewers can use the following questions as pointers to perform their assessment of the submitted manuscript and as a guide to preparing their review report:
						<ul style="margin-top: -26px;">
							...
							<li>Are the study materials, methods,struments used, and measurements made clearly described?</li>
							<li>Are the research methods valid, reliable, reproducible, and meet requirements for best practices?</li>
							<li>Are ethical standards followed implementing the research and writing the manuscript?</li>
							<li>What did the study find and has this been clearly described?</li>
							<li>Are the results of the manuscript presented a logical and coherent manner?</li>
							...
							<li>Are there issues with titles, labels, statistical notation or image quality of tables, graphics, figures, imagescluded the manuscript?</li>
							...
							<li>Does the manuscript discuss the gaps orconsistencies on the topic and ways forward described?</li>
							<li> <span id="8"></span>Is the referencing accurate, adequate and balance relation to the topic of the manuscript?</li>
						</ul>
					</p>
					...
					<h4>Rating the Manuscript</h4>
						<p>In addition to the above outlined questions, reviewers should rate the manuscript following the different aspects provided below: 
							<ul style="margin-top: -26px;">
								...
								<li><b>Scientific Accuracy:</b> Was the study design correct and sound? Do the methods employed follow expected standards the study context? Are the data analyses choices and implementation of the highest technical standards within the scope of the topic area? Are the data and emanated results sufficiently robust to draw conclusions? </li>
								<li><b>Interest to Readers:</b> Are the findings and conclusions of the manuscript ofterest to the readership of ASFIRJ? </li>
								<li><b>Overall Merit:</b> Does the manuscript have an overall benefit to warrant publication ASFIRJ? Do the findings of the manuscript advance current knowledge the topic area? <span id="9"></span> </li>
					...
					<h4>Giving Your Overall Recommendation</h4>
						<p>Your overall recommendation to the handling editor should come either of the four underlisted decision paths, which must be clearly well justified. 
							<ul style="margin-top: -26px;">

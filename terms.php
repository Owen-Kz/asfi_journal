			...
			<div class="col-lg-12 padding-15">
				<div class="blog-single-wrap">
					...
					<div class="blog-single-content">
						...
						<p>
							This Website and all logos, texts, graphics, trade-marks, images are the property of (or used under license by) ASFI and are protected under the applicable intellectual property legislation and regulations world-wide, including Africa. The contents of this Website, (including namely all logos, texts, graphics, trade-marks, images, videos, soundtracks and any other element of this Website) cannot, in part or in whole, be copied, duplicated, printed, archived, re-edited, downloaded, displayed, sold, assigned, transferred, modified or otherwise diffused, on paper format or other format created or to be created, electronic or other, without ASFI’ prior written consent. However, you may view and print elements that are part of this Website but strictly for private, personal and non-commercial use and provided that such copy clearly display the copyright and trademark notices. Any rights not expressly granted to you in these Terms are expressly reserved by ASFI. For greater certainty, you agree that you will not take any action that is inconsistent with ASFI’ ownership of the Website and its content.
						</p>
					</div>
					...
					<div class="blog-single-content">
						...
						<p>
							Without limiting the generality of the foregoing, the ASFI trademark and the figurative trademarks related to ASFI that are displayed on this Website are registered trademarks and are the exclusive property of ASFI, its subsidiaries, its affiliates, its members, its suppliers or its distributors and are protected under the applicable trademarks legislation and regulations world-wide, including Africa. The trademarks and figurative trademarks which are not the property or ASFI are the property of their respective owners.
						</p>
					</div>
					...
					<div class="blog-single-content">
						...
						<p>
							We invite you to consult the hyperlinks in this Website, which allow you to access various pages of this Website or to websites owned by third parties.
						</p>
						<p>
							The hyperlinks allowing access to websites owned by third parties are supplied for informative purposes only. ASFI does not have any control on these websites and is not responsible of their contents. The Released Parties decline any and all liability in relation with the contents or in relation with any representation or information contained in any and all websites owned by any third party and accessible by hyperlink. These third party websites may have their own privacy policies and terms and conditions that are not governed by these Terms. The Released Parties are not responsible for the privacy practices or the content of any website(s) owned and operated by any such subsidiaries, affiliates or third parties, so ASFI encourages you to carefully read and review the privacy policy and terms and conditions for each third party website you visit.
						</p>
						<p>
							Unless indicated otherwise, the presence, on this Website, of one or many hyperlinks to access a website owned by a third party must under no circumstances be interpreted as an endorsement, by ASFI, of any representation or information contained on any such website or as a partnership or affiliation with the owner of any such website.
						</p>
					</div>
					...
					<div class="blog-single-content">
						...
						<p>
							The products and articles displayed on this Website are products and articles that may be offered for sale in Africa by ASFI. ASFI uses its best efforts to provide an accurate description of the products or articles that may be offered for sale. ASFI does not guarantee the exactitude, completeness or reliability of these descriptions, including any indication related to the price of a product or of an article.
						</p>
						<p>
							ASFI declines any liability for any and all inaccuracy, error or omission in the information contained on this Website in relation with the products and articles that may be offered for sale by ASFI, including their prices. ASFI reserves the right to make any changes at any time with prior notice. The information related to these products and articles may be changed, replaced or deleted at any time with prior notice by ASFI.
						</p>
						<p>
					...
					<div class="blog-single-content">
						...
						<p>
							These Terms are binding upon you, your heirs, executors, beneficiaries, successors and assigns and you may not assign your rights under these Terms to any other party without ASFI’ prior written consent, which consent may be withheld in our sole and absolute discretion.
						</p>
					</div>

...
<style>
    .page-header {
        background: linear-gradient(135deg, #2d1b69 0%, #4a2b8a 55%, #6b3fa0 100%);
        position: relative;
        overflow: hidden;
    }
    .page-header .overlay {
    ...
    <div class="overlay">
        <div class="container">
            <div class="page-content text-center">
                ...
                <h2>ASFIRJ Special Issues</h2>
                <p class="w-90 xl:w-50 m-auto">Explore our curated collection of special issues featuring cutting-edge research, thematic compilations, and comprehensive reviews on critical topics in African scientific advancement.</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row g-4">
            ...
            <div class="col-md-3 col-sm-6">
                <div class="fact-card">
                    ...
                    <p>In-depth exploration of topics with multiple perspectives</p>
                </div>
            </div>
        </div>
    </div>
...
<style>
  ...
  .asfirj-share-btn.email    { background: #4a2b8a; }

...
<head>
	...
	<meta name="apple-mobile-web-app-title" content="ASFI Research Journal - About">
...
<body class="header-1 business">
	...
	<section class="page-header padding">
		<div class="overlay padding">
			<div class="container">
				...
				<div class="next-section-placeholder" id="ASFI"></div>
	...
	<section class="service-section bg-grey bd-bottom padding">
		<div class="container">
			<div class="section-heading mb-40 text-center wow fadeInUp" data-wow-delay="200ms">
				<h2>African Science Frontiers Initiatives</h2>
				<h4>(ASFI)</h4>
			...
			<div class="next-section-placeholder" id="aims"></div>
			...
			<div class="row">
				<div class="col-md-6 wow fadeInLeft" data-wow-delay="200ms">
					<div class="section-heading">
						<h2>ASFIRJ's AIMS & SCOPE</h2>
						<p>
							ASFIRJ is the official journal of the African Science Frontiers Initiatives (ASFI). ASFIRJ
				...
				<div class="col-md-6 wow fadeInRight">
					<div class="about-bg-holder">
						...
						<div class='top-space'>
							...
							<p>
								ASFI also hosts ASFIScholar, a platform that provides African scholars and
					...
					<div class="next-section-placeholder" id="values"></div>
	...
	<div class="about-main-section">
		<div class="info wow fadeInUp" data-wow-delay="200ms">
			...
			<div class="next-section-placeholder" id="prompt"></div>
	...
	<section class="service-section bg-grey bd-bottom padding">
		<div class="container">
			<div class="section-heading mb-40 text-center wow fadeInUp" data-wow-delay="200ms">
				<h2>Prompt Decisions and Rapid Publication Timelines</h2>
				<div class="justify-content-between d-flex flex-wrap notice_notify" style="justify-content: center;">
					<div>
						<h4>Median Decision Time:</h4>

						<p style="text-align: start;">7 days for editorial rejection without external peer review. <br>
							28 days for manuscript that undergo peer review.</p>
					</div>
					<div>
						<h4>Fast Publication:</h4>

						<p>Median time from acceptance to publication 14 days.</p>
					</div>
					<div>
						<h4>ASFIRJ Fast-Track:</h4>

						<p style="text-align: start;">Expedited peer review and online publication within 4 weeks of
							late-breaking submissions to be presented at major scientific meetings and those with
							time-sensitive findings of major scientific, policy, or societal importance.</p>
					</div>
		...
		<div class="next-section-placeholder" id="why-section"></div>
	...
	<section class="why-section about-section bd-bottom padding">
		...
		<div class="why-items-bg wow fadeInLeft" data-wow-delay="200ms">
			<div class="why-items">
				<div class="jog">
					<div class="why-item animate-slide">
						<svg xmlns="http://www.w3.org/2000/svg"
							viewBox="0 0 640 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
							<path fill="#8266d6"
						...
						<div class="sub-text">
							...
							<span>High quality and prompt peer review and editorial assessment of all submissions,
								accepting only articles that meet the highest scientific standards.<span>
						</div>
					</div>
				</div>
				...
				<div class="jog">
					<div class="why-item animate-slide">
						...
						<div class="sub-text">
							...
							<span>All accepted oral and poster abstracts at the ASFI Annual Conference are published in
								ASFIRJ.</span>
						</div>
					</div>
				...
				<div class="jog">
					<div class="why-item animate-slide">
						...
						<div class="sub-text">
							<span>Fast and device-responsiveness:</span>
							<span>Fast and device-responsive website for publication of accepted submissions. </span>
						</div>
					</div>
					<div class="next-section-placeholder" id="open-access"></div>
		...
		<div class="container">
			<div style="display: flex; flex-direction: column; justify-content: center;">
				<div class="col-md-12 wow fadeInLeft" data-wow-delay="200ms">
					<div class="section-heading">
						<h2>Open Access and Author Licensing</h2>
						<p>
							ASFIRJ uses the <a href="https://creativecommons.org/share-your-work/cclicenses/"
								target="_blank" style="color: blueviolet;">Creative Commons Attribution (CC-BY)</a>
							license type for the works it publishes. Under this license type, authors agree to make
							their articles legally available to be reused for any purpose without permission or fees. In
							this case, anyone can copy, distribute, or reuse ASFIRJ articles, as long as the author and
							original source are properly cited.</p>
				...
				<div class="col-md-10 wow fadeInRight">
					...
					<div class="next-section-placeholder" id="indexing"></div>
				</div>
			</div>
		...
		<div class="container">
			...
			<div style="display: flex; flex-direction: column; justify-content: center;">
				...
				<div class="col-md-10 wow fadeInRight">
					...
					<div class="next-section-placeholder" id="fees"></div>
				</div>
		</div>
	...
	<li><b>Secure Digital Backup: </b>All published content is regularly backed up and stored on secure, ASFIRJ redundant server to prevent data loss.  </li>
		...
		<li><b>Repository Indexing and Accessibility: </b>Where applicable, ASFIRJ supports the inclusion of its articles in established repositories and indexing platforms (e.g., institutional repositories and subject-based archives) to enhance discoverability and redundancy. </li>
			...
			<li><b>Persistent Identifiers: </b>All articles are assigned persistent identifiers (such as DOIs), ensuring stable and reliable access over time. </li>
				...
				<p style="width:90%; margin:auto;">In the event that ASFIRJ is no longer published, all journal content will remain accessible through its archiving partners and repositories, ensuring that the scholarly record is preserved and remains permanently available.
</p>
			</div>
			<!-- <div class="next-section-placeholder" id="archiving"></div> -->
					...
					<div class="col-lg-3 col-sm-6 sm-padding">
						<div class="footer-widget link-widget">
							...
							<ul class="widget-links">
								...
								<li><i class="fas fa-square-full"></i><a href="./authors.html#ob"
										class='menu-item'>Submission Process</a></li>
							</ul>
							<a href="">
								<h3 style="margin-top: 80px; font-size: 25px">ISSN: 3043-4262</h3>
							</a>
						</div>
					</div>
					<div class="col-lg-3 col-sm-6 sm-padding">
		...
		<div class="footer-bottom">
			<div class="container">
				...
				<div class="copyright-wrap">
					<p>&copy; <span id="currentYear"> </span> <a href="https://asfirj.org/">ASFI Research Journal</a>
						All Rights Reserved ||VO.</p>
				</div>

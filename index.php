  ...
  <div class="container banner-inner">
				...
				<div class="primary-header-inner" style="display:flex; flex-direction:column; align-items: start;" style="display:flex; flex-direction:column; align-items: start;">
					...
					<div class="header-menu-wrap" style="width: 100%;" style="width: 100%;">
						<ul class="dl-menu ">
							...
							<li><a href="./aboutus.html" class='menu-item dropdown'>About</a>
	...
	<div id="myCarousel" class="carousel" data-ride="carousel">
		...
		<a class="left carousel-control" style="display: flex; justify-content: center; align-items: center;" href="#myCarousel" role="button" data-slide="prev">
			<span class="fa fa-arrow-left" aria-hidden="true"></span><span class="sr-only">
				Previous</span> </a><a class="right carousel-control" style="display: flex; justify-content: center; align-items: center;" href="#myCarousel" role="button"
			data-slide="next"><span class="fa fa-arrow-right" aria-hidden="true"></span><span class="sr-only">Next</span> </a>
	</div>
	<!-- /.carousel -->
...
<section class="about-section bd-bottom padding article-bottom" style="
	...
	">
		...
		<div class="article-side" style="background-color: whitesmoke;">
...
<hr>
  ...
  <ul class="unordered-bordered-list">
	...
	<a href="./special.html"><div class="DST-iframe-nojobs"> <img src="./images/event2.jpeg" alt="" style="width:100%; border-radius: 15px;"> </div></a>

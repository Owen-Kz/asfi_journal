    ...
    <main>
        ...
        <div class="main-submit-container">
            <div class="submission-header">
                ...
                <ul class="submit-nav">
                    <a href="submitManuscriptSignUp.html"><li>SignUp</li></a>
            ...
            <div class="submit-container">
                <div class="submit-body">
                    <form id="loginForm" onsubmit="return false">
                        ...
                        <p style="margin: auto;">Forgotten Password? Cick <a href="./forms/passwwordResetForm.html" style="color: blueviolet;">here</a> to retrieve.</p>
...
<script>
    window.location.href="./manuscriptPortal.html"
</script>

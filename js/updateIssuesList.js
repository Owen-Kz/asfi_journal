...
async function UpdateIssues(articleList) {
    ...
    articleList.forEach((article, index) => {
      ...
      let coverImage = `https://asfirj.org/useruploads/article_images/${coverPhoto}`? `https://asfirj.org/useruploads/article_images/${coverPhoto}`: `https://res.cloudinary.com/dvm0bs013/image/upload/v1738234900/asfischolar_asbtdc.jpg`
        ...
        const editorsChoiceBadge = isEditorsChoice === "yes"
            ? `<span class="editchoice"><svg style="width:20px;" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M19.965 8.521C19.988 8.347 20 8.173 20 8c0-2.379-2.143-4.288-4.521-3.965C14.786 2.802 13.466 2 12 2s-2.786.802-3.479 2.035C6.138 3.712 4 5.621 4 8c0 .173.012.347.035.521C2.802 9.215 2 10.535 2 12s.802 2.785 2.035 3.479A3.976 3.976 0 0 0 4 16c0 2.379 2.138 4.283 4.521 3.965C9.214 21.198 10.534 22 12 22s2.786-.802 3.479-2.035C17.857 20.283 20 18.379 20 16c0-.173-.012-.347-.035-.521C21.198 14.785 22 13.465 22 12s-.802-2.785-2.035-3.479zm-9.01 7.895-3.667-3.714 1.424-1.404 2.257 2.286 4.327-4.294 1.408 1.42-5.749 5.706z" fill="#4d91f7"></path></svg> <span>Editor's Choice</span></span>`
            : "";
        ...
        articlesHTML += `
            <div class="issue-item" style="display: flex;">
                <div class="issue-image" style="background-image: url(${coverImage});"></div>
                <div class="issue-content">
                    ...
                    <div class="content-item-format-links">
                        <ul class="format-links">
                            ...
                            <li class="stats"><span class="stat-count">${viewsCount}</span> Views</li>
                            <li class="stats"><span class="stat-count">${downloadsCount}</span> Downloads</li>
                            <li><button class="share-btn" aria-label="Share for ${articleTitle}">Share</button></li>
                        </ul>
                    </div>
  ...
  <ul class="share-list">
    <li class="shareOption" title="Share on ASFIScholar" data-platform="asfischolar">
      <img src="https://asfirj.org/images/ASFIScholar_Logo.png" alt="ASFIScholar" />
      <span>ASFISCHOLAR</span>
    </li>

    <li class="shareOption" title="Share on Twitter" data-platform="twitter">
    ...
    <li class="shareOption" title="Share on WhatsApp" data-platform="whatsapp">
      <?xml version="1.0" ?><svg id="Layer_1" style="enable-background:new 0 0 1000 1000;" height="32px" width="32px" version="1.1" viewBox="0 0 1000 1000" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><style type="text/css">
	.st0{fill:#25D366;}
    ...
    <li class="shareOption" title="Copy Link" data-platform="instagram">
      <?xml version="1.0" ?><!DOCTYPE svg  PUBLIC '-//W3C//DTD SVG 1.1//EN'  'http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd'><svg height="32px" width="32px" id="Layer_1" style="enable-background:new 0 0 512 512;" version="1.1" viewBox="0 0 512 512" width="512px" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><g><polygon points="304,96 288,96 288,176 368,176 368,160 304,160  "/><path d="M325.3,64H160v48h-48v336h240v-48h48V139L325.3,64z M336,432H128V128h32v272h176V432z M384,384H176V80h142.7l65.3,65.6V384   z"/></g></svg>
      <span>Copy Link</span>
    </li>
  </ul>
</div>

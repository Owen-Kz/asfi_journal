...
<body class="header-1 business"  style="height: 100vh;">


<div class="main-submit-container"  style="height: 100vh;">

    <div class="submit-container"  style="height: 100vh;">
        <div class="submit-body" style="height: 100vh; align-items: center; justify-content: center; display: flex; width: 90%; margin: auto;">
            <form id="verifyCode" style="width: 100%; display: flex;">
                <label for="code"> Enter Verification Code</label>
                <input class="form-control"  type="password" name="code" id="code">
                <button  class="btn btn-info submit">Verify</button>
            </form>
        </div>
    </div>
</div>

<script type="module" src="../../js/queries/verifyManageCode.js?v=<?= time(); ?>"></script>

...
<title> ASFI Research Journal - Manage Issues</title>
...
<body class="header-1 business">
    ...
    <div style="background-color: rgba(128, 128, 128, 0.089); border-radius: 8px; width: 20%; text-align: center; margin-left: 20px; margin-bottom: 10px; padding: 6px;">
        <a href=""  style="background-color: blueviolet;padding: 2% 10% 2% 10%; margin-left: 0; color: whitesmoke; border-radius: 8px;">Issues</a>
        <a href="../../manuscriptPortal/manage/" style="color: rgb(85, 84, 84);">Supplements</a>
    </div>
    <span style="margin-left: 10px;">
        ...
        <h3 style="text-align: center;">Manage Issues</h3>

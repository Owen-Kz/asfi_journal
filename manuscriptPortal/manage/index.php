...
<title> ASFI Research Journal - Manage Supplements</title>
    <meta name="title" Content="ASFI Research Journal - Supplements">
    ...
    <meta name="apple-mobile-web-app-title" content="ASFI Research Journal - Supplements">
    
    <meta itemprop="name" content="ASFI Research Journal - Supplements">
    ...
    <meta property="og:url" content="supplements.html">
...
<body class="header-1 business">
                                ...
                                <form id="searchArticle">
                                    <div class="d-flex flex-wrap gap-4 filter-card" style="align-items: flex-end;">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <select id="authorsOptionManagement" class="form--control">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <select class="form--control " id="typeOptionManagement">
                                                <option value="all">Any</option>

                                            </select>
                                        </div>
                                        <div class="flex-grow-1 ">
                                            <button class="btn btn--base w-100" style="background-color: #80078b; color:whitesmoke"><i class="las la-filter"></i>
                                                Filter</button>
                                        </div>
                                    </div>
                                </form>
    ...
    <div style="background-color: rgba(128, 128, 128, 0.089); border-radius: 8px; width: 20%; text-align: center; margin-left: 20px; margin-bottom: 10px; padding: 6px;">
        <a href="../../manuscriptPortal/manageIssues/" style="color: rgb(85, 84, 84);" >Issues</a>
    ...
    <span style="margin-left: 10px;">
        ...
        <h3 style="text-align: center;">Manage Supplements</h3>
        ...
        <nav aria-label="..." style="display: flex; justify-content: center;">
            <ul class="pagination" id="pagination_container" style="align-items:center; justify-content:center; flex-direction:column; ">
...
<script src="../../js/queries/manageArticles.js" type="module"></script>

<script src="https://cdn.quilljs.com/1.3.6/quill.js?"></script>

<script src='https://cdnjs.cloudflare.com/ajax/libs/vue/2.6.10/vue.min.js'></script>
<script type="module" src="../../js/forms/articleEdit.js?v=<?= time(); ?>"></script>

...
<title> ASFI Research Journal - Issues</title>
    <meta name="title" Content="ASFI Research Journal - Issues">
    ...
    <meta name="apple-mobile-web-app-title" content="ASFI Research Journal - Issues">
    
    <meta itemprop="name" content="ASFI Research Journal - Issues">
    ...
    <meta property="og:url" content="issues">
   ...
   <section class="page-header padding">
	...
	<div class="container">
		<div class="page-content text-center">
			<div class="short-nav">
				<a href="https://asfirj.org/">Home</a><span>>>></span><a href="">Issues</a>
			</div>
			<h2>Issues</h2>
			<p>
				Browse Issues
    ...
    <main id="supplements">
                                ...
                                <form id="searchArticle">
                                    <div class="d-flex flex-wrap gap-4 filter-card" style="align-items: flex-end;">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <select id="authorsOption" class="form--control">
        ...
        <div style="display: flex; justify-content: space-between;">
            <div style="background-color: rgba(128, 128, 128, 0.089); border-radius: 8px; width: 50%; text-align: center; margin-left: 20px; margin-bottom: 10px; padding: 6px;">
                ...
                <a href="../supplements#supplements/" style="color: rgb(85, 84, 84);">Supplements</a>
            </div>
...
<script src="../js/queries/allIssues.js?v=<?= time(); ?>vsfaaf" type="module"></script>

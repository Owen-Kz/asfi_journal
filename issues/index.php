...
// Include the issues renderer component
include '../backend/partials/renderIssues.php';
?>
...
<main id="supplements">
    ...
    <!-- <div style="display: flex; justify-content: space-between; align-items: center; margin: 20px;">
        <div style="background-color: rgba(128, 128, 128, 0.089); border-radius: 8px; display: inline-block; padding: 6px;">
            <a href="?" style="background-color: blueviolet; padding: 8px 20px; color: whitesmoke; border-radius: 8px; text-decoration: none; display: inline-block;">Issues</a>
            <a href="../supplements#supplements/" style="color: rgb(85, 84, 84); padding: 8px 20px; text-decoration: none;">Supplements</a>
        </div>
    ...
    <div class="issueslay" style="display: flex; gap: 30px; padding: 20px; justify-content: center;">

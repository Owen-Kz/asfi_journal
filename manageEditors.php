...
<head>
    ...
    <meta name="apple-mobile-web-app-title" content="ASFI Research Journal - Editors">
    ...
    <meta property="og:url" content="editors.html">
...
const navItems = document.querySelectorAll('#editorialNav li');
navItems.forEach(item => item.classList.remove('active')); // Remove active class from all items
navItems[new Number(index)].classList.add('active'); // Add active class to clicked item
...
<?php include './components/top-navbar.php'; ?>
        ...
        <div class="overlay padding">
            <div class="max-w-7xl mx-auto px-4">
                <div class="page-content text-center">
                    <div class="short-nav">
                        <a href="https://asfirj.org/">Home</a><span>>>></span><a href="">Editors</a>
                    </div>
                    <h2>Editors</h2>
                    <p>
                        Meet The Editors
    ...
    <main>
        ...
        <div class="main-submit-container">
            ...
            <div style=" overflow-y: scroll; height: 80vh; position: sticky; top: 90px; padding-left: 20px;" class="submission-header">
            <div class="submission-header" style="width: 100%;">
                <h3>Editors</h3>
                <ul class="submit-nav" id="editorialNav">
 
                </ul>
            </div>
        </div>
            <div class="submit-container">
                <div class="submit-body" style="margin: 0 8px 0 8px;" id="ae">
        ...
        <div id="editorModal" class="fixedset-0 z-50 hidden">
            ...
            <div class="relative bg-white rounded-lg shadow-xl">
                ...
                <form id="editAuthor" enctype="multipart/form-data">
...
<?php include './components/footer.php'; ?>
    ...
    <script type="module" src="./js/queries/manageEditorsForFront.js"></script>

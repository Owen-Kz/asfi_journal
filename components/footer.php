            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6 sm-padding">
                    <div class="footer-widget">
                        ...
                        <p>At ASFIRJ, we prioritize our publishers' expectations. With clear guidance, we ensure effective management and delivery. Join us in upholding excellence in research publishing.</p>
                    </div>
                </div>
                    ...
                    <div class="footer-widget">
                        ...
                        <div class="subscribe-form">
                            <form class="subscribe-form newsLetterForm" id="newsLetterForm">
                                <input class="form-control" type="email" name="email" placeholder="Email *" required id="subscribeEmail">

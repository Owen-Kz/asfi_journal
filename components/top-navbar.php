            ...
            <div class="primary-header-inner" style="display:flex; flex-direction:column; align-items: start;">
                ...
                <div class="header-menu-wrap" style="width: 100%;">
                    <ul class="dl-menu">
                        ...
                        <li>
                            <a href="https://asfirj.org/aboutus.html" class='menu-item dropdown'>About</a>
                            <ul class="dropdown-menu aboutDropDown">
                                <li><a href="https://asfirj.org/aboutus.html#ASFI" class='menu-item'>African Science Frontiers Initiatives</a></li>
                                <li><a href="https://asfirj.org/aboutus.html#aims" class='menu-item'>ASFIRJ's AIMS & SCOPE</a></li>
                                <li><a href="https://asfirj.org/aboutus.html#values" class='menu-item'>ASFIRJ Values</a></li>
                                <li><a href="https://asfirj.org/aboutus.html#prompt" class='menu-item'>Prompt Decisions and Rapid Publication Timelines</a></li>
                                <li><a href="https://asfirj.org/aboutus.html#why-section" class='menu-item'>Why Publish in ASFIRJ?</a></li>
                                <li><a href="https://asfirj.org/aboutus.html#open-access" class='menu-item'>Open Access and Author Licensing</a></li>
                                <li><a href="https://asfirj.org/aboutus.html#fees" class='menu-item'>Article Publication Fee</a></li>
                            </ul>
                        </li>
                        <li class="dropdown">

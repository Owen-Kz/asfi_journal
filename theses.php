...
<head>
    ...
    <meta property="og:url" content="theses.php">
    ...
    <style>
        ...
        /* For large screens: content max-width 70% of parent width, centered */
        .content-center {
            max-width: 70%;
            margin-left: auto;
            margin-right: auto;
        ...
        .card-item ul, .card-item .list-content {
            margin: 0;
            padding-left: 1.2rem;
        }
        .card-item li {
    ...
    <div class="overlay padding">
        <div class="container">
            <div class="page-content text-center">
                ...
                <h2>ASFIRJ Theses</h2>
                <p>Giving Academic Theses a Permanent Scientific Voice</p>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-md-12 wow fadeInUp" data-wow-delay="200ms">
                ...
                <div class="cards-grid">
                    <!-- Card 1: Conduct rigorous research -->
                    <div class="card-item">
                    ...
                    <div class="card-item">
                        ...
                        <h4>Communicate scientific findings clearly</h4>
                        <p>Articulate complex ideas with precision, making impactful contributions accessible to the scholarly community.</p>
                    </div>
                    <!-- Card 3: Contribute to scholarly discourse -->
                    <div class="card-item">
            ...
            <div class="col-md-12 wow fadeInUp" data-wow-delay="200ms">
                ...
                <div class="cards-grid">
                    ...
                    <div class="card-item benefits-card">
                        ...
                        <h4>Strengthens scholarly identity</h4>
                        <p>Establishes your voice within the academic community and shapes your research profile.</p>
                    </div>
                    <div class="card-item benefits-card">
            ...
            <div class="col-md-12 wow fadeInUp" data-wow-delay="200ms">
                ...
                <div class="cards-grid">
                    <div class="card-item">
                        ...
                        <p>Undergraduate research showcasing foundational scholarly work and original analysis.</p>
                    </div>
                    <div class="card-item">
                        <div class="card-icon"><i class="fas fa-chalkboard-user"></i></div>
                        <h4>Master's Theses</h4>
                        <p>Advanced research with substantive contribution to disciplinary knowledge.</p>
                    </div>
                    <div class="card-item">
                        <div class="card-icon"><i class="fas fa-landmark"></i></div>
                        <h4>Doctoral Theses</h4>
                        <p>High-impact, original research that advances scientific frontiers and theory.</p>
                    </div>
                </div>
                <p class="text-center mt-3">The thesis may have been completed recently or many years ago, provided it meets the publication requirements.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="about-section bd-bottom padding">
    <div class="container content-center">
        ...
        <div class="cards-grid scientific-cards">
            <div class="card-item scientific-card">
                <div class="card-icon"><i class="fas fa-brain"></i></div>
                <h4>Refine Scientific Understanding</h4>
                <p>Even unexpected or null results help sharpen theories, correct misconceptions, and deepen collective knowledge.</p>
            </div>
            <div class="card-item scientific-card">
                <div class="card-icon"><i class="fas fa-ban"></i></div>
                <h4>Prevent Unnecessary Duplication</h4>
                <p>Published findings alert other researchers to what has already been tested, saving time and resources.</p>
            </div>
            <div class="card-item scientific-card">
...
<style>
/* Checklist styling to match the card/checklist aesthetic */
.checklist-grid {
    display: flex;
    flex-direction: column;
    gap: 1.5rem;
    ...
    <div class="container content-center">
        ...
        <div class="cards-grid">
            <div class="card-item">
                ...
                <p>Eligible theses are published within one week of acceptance.</p>
            </div>
            <div class="card-item">
                <div class="card-icon"><i class="fas fa-globe"></i></div>
                <h4>Permanent online visibility</h4>
                <p>Published theses remain perpetually accessible on the ASFIRJ website.</p>
            </div>
            <div class="card-item">
                <div class="card-icon"><i class="fas fa-certificate"></i></div>
                <h4>Formal citation credentials</h4>
                <p>Each published thesis receives a DOI, making it fully citable.</p>
            </div>
            <div class="card-item">
                <div class="card-icon"><i class="fas fa-hourglass-half"></i></div>
                <h4>No time limitation</h4>
                <p>Theses can be published regardless of how long ago they were completed.</p>
            </div>
            <div class="card-item">
        ...
        <div class="section-heading wow fadeInUp">
            ...
            <div style="overflow-x: auto;">
                <table class="table-fees m-auto" style="width:100%; border-collapse: collapse; margin-top:1rem;">
                    <thead>
                        <tr><th>Number of Pages</th><th>ASFI Members (30% Discount)</th><th>Non-ASFI Members</th></tr>
                    </thead>
                    <tbody>
                        <tr><td>1–100 pages</td><td>USD 105</td><td>USD 150</td></tr>
                        <tr><td>101–200 pages</td><td>USD 140</td><td>USD 200</td></tr>
                        <tr><td>More than 200 pages</td><td>USD 210</td><td>USD 300</td></tr>
                    </tbody>
                </table>
            </div>
        </div>
        ...
        <div class="declarations-checklist">
            <div class="declaration-card">
                <label class="declaration-checkbox">
                    <input type="checkbox" class="styled-checkbox" disabled checked>
                    <div class="declaration-content">
                        <div class="declaration-icon">
                            <i class="fas fa-file-alt"></i>
                        </div>
                        <div class="declaration-text">
                            <strong>Completion & Approval Confirmation</strong>
                            <span>I confirm that the thesis has been completed, defended, and approved, with documentation attached.</span>
                        </div>
            ...
            <div class="declaration-card">
                <label class="declaration-checkbox">
                    ...
                    <div class="declaration-content">
                        ...
                        <div class="declaration-text">
                            <strong>Exclusive Submission</strong>
                            <span>I confirm that the thesis is submitted solely to ASFIRJ and not under consideration elsewhere.</span>
                        </div>
                        <span class="checkmark"></span>
                    </div>
                </label>
            ...
            <div class="declaration-card">
                <label class="declaration-checkbox">
                    ...
                    <div class="declaration-content">
                        ...
                        <div class="declaration-text">
                            <strong>Ethical & Legal Compliance</strong>
                            <span>I confirm ethical and legal compliance of the research.</span>
                        </div>
                        <span class="checkmark"></span>
                    </div>
                </label>
            ...
            <div class="declaration-card">
                <label class="declaration-checkbox">
                    ...
                    <div class="declaration-content">
                        ...
                        <div class="declaration-text">
                            <strong>Publication Fee Commitment</strong>
                            <span>I confirm willingness to pay the publication fee if accepted.</span>
                        </div>
                        <span class="checkmark"></span>
                    </div>
                </label>
...
<style>
/* Declarations Checklist Styles - Icon Left, Check Right */
...
.declaration-card:hover {
    border-color: #8266d6;
    box-shadow: 0 8px 20px rgba(130, 102, 214, 0.1);
...
.declaration-card:hover .checkmark {
    border-color: #8266d6;

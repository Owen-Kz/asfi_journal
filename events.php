   ...
   <section class="page-header padding">
	...
	<div class="container">
		<div class="page-content text-center">
			<div class="short-nav">
				<a href="https://asfirj.org/">Home</a><span>>>></span><a href="">Events</a>
			</div>
			<h2>Events</h2>
			<p>
				Our Events
    ...
    <main>
        <div class="all-event-section">
            ...
            <div class="upcoming-events-list">
                ...
                <div class="events-list-items">
                    <div class="events-list-item">
                        <a href="./event2.html">3rd Annual ASFI Multidisciplinary Conference & Boot Camp</a>
                        <h4>25th - 27th November 2025</h4>
                        <div class="upcoming-event-video-frame">
                            ...
                            <img width="100%" height="100%" src="./images/event2025.jpeg" alt="">
                        </div>
                    </div>
                ...
                <!-- <div class="see-more-link">
                    <a href="event2.html">View More &rarr;</a>
                </div> -->
            ...
            <div class="upcoming-events-list">
                ...
                <div class="events-list-items">
                     <div class="events-list-item">
                        <a href=""> ASFI 5th Anniversary Celebration 14th July 2025</a>
                        <h4>July 2025</h4>
                        <div class="upcoming-event-video-frame">
            
                            <!-- Add your video iframe here -->
                            <iframe width="10%" height="100%" src="https://www.youtube.com/embed/vhHnj1IF04Q?si=IFbNaBtPQ_06uwhr" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                        </div>
                    </div>
                    

                    <div class="events-list-item">
                        <a href="">ASFI 2024 Virtual Multidisciplinary Conference & Boot Camp</a>
                        <h4>November 2024</h4>
                        <div class="upcoming-event-video-frame">
            
                            <!-- Add your video iframe here -->
                           <iframe width="100%" height="100%" src="https://www.youtube.com/embed/SquVnsjfepE?si=NMhiPTpbydzw30WQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                        </div>
                    </div>
                    <div class="events-list-item">
                        <a href="">ASFI 2023 Virtual Multidisciplinary Conference & Boot Camp</a>
                        <h4>November 2023</h4>
                        <div class="upcoming-event-video-frame">
                ...
                <!-- <div class="see-more-link">
                    <a href="./event1.html">View More &rarr;</a>
                </div> -->

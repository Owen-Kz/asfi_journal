    ...
    <div class="w-full bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-all duration-300 mb-6">
        ...
        <div class="p-4 md:p-5">
            ...
            <div class="flex flex-wrap items-center gap-2" style="justify-content: space-between;">
                ...
                <a href="' . $manuscriptFileURL . '" target="_blank" class="px-3 py-4 bg-gray-100 hover:bg-orange-100 text-orange-600 rounded-lg transition-colors flex items-center gap-1 text-sm font-medium">

    ...
    <div class="w-full bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-all duration-300 mb-6">
        ...
        <div class="p-6">
            ...
            <div class="flex flex-wrap items-center gap-3">
                ...
                <a href="https://asfirj.org/useruploads/manuscripts/' . $manuscriptFile . '" target="_blank" class="downloadLink px-6 py-3 bg-gray-100 hover:bg-purple-100 text-purple-700 rounded-lg transition-colors flex items-center gap-2 text-base font-medium">

            ...
            <div class="submit-container">
                <div class="submit-body">
                    <form id="loginForm">
						...
						<p style="margin: auto;">Cick <a href="../signup/" style="color: blueviolet;">here</a> to create an account if you don't have one.</p>
                        <p style="margin: auto;">Forgotten Password? Cick <a href="../resetPassword/" style="color: blueviolet;">here</a> to retrieve.</p>                       

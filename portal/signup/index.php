...
<body class="bg-gray-50 font-sans">
    ...
    <div id="successPopup" class="fixed top-4 right-4 bg-green-500 text-white p-4 rounded-lg shadow-lg z-50 hidden fade-in">
        <div class="flex items-center">
                        ...
                        <form id="registerForm" class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                                <div class="md:col-span-1">
                                    ...
                                    <select name="prefix" id="prefix" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-asfi-blue focus:border-asfi-blue" required>
                                ...
                                <div class="md:col-span-3 grid grid-cols-1 md:grid-cols-3 gap-6">
                                    <div>
                                        ...
                                        <input type="text" name="first_name" id="first_name" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-asfi-blue focus:border-asfi-blue" placeholder="First Name" required>
                                    </div>
                                    
                                    <div>
                                        <label for="last_name" class="block text-sm font-medium text-gray-700 mb-1">Last Name</label>
                                        <input type="text" name="last_name" id="last_name" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-asfi-blue focus:border-asfi-blue" placeholder="Last Name" required>
                                    </div>
                                    
                                    <div>
                                        <label for="other_name" class="block text-sm font-medium text-gray-700 mb-1">Other Name</label>
                                        <input type="text" name="other_name" id="other_name" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-asfi-blue focus:border-asfi-blue" placeholder="Other Name">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="email" name="email" id="email" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-asfi-blue focus:border-asfi-blue" placeholder="Email Address" required>
                                </div>
                                
                                <div>
                                    <label for="orcid" class="block text-sm font-medium text-gray-700 mb-1">ORCID ID (Optional)</label>
                                    <input type="text" name="orcid" id="orcid" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-asfi-blue focus:border-asfi-blue" placeholder="ORCID ID">
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div>
                                    ...
                                    <input type="text" name="affiliation" id="affiliation" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-asfi-blue focus:border-asfi-blue" placeholder="Institution/Organization" required>
                                </div>
                                
                                <div>
                                    <label for="affiliation_country" class="block text-sm font-medium text-gray-700 mb-1">Country</label>
                                    <input type="text" name="affiliation_country" id="affiliation_country" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-asfi-blue focus:border-asfi-blue" placeholder="Country" required>
                                </div>
                                
                                <div>
                                    <label for="affiliation_city" class="block text-sm font-medium text-gray-700 mb-1">City</label>
                                    <input type="text" name="affiliation_city" id="affiliation_city" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-asfi-blue focus:border-asfi-blue" placeholder="City" required>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <select name="discipline" id="discipline" class="discipline w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-asfi-blue focus:border-asfi-blue" required>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="password-container">
                                    ...
                                    <input type="password" name="password" id="password" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-asfi-blue focus:border-asfi-blue pr-10" placeholder="Password" required>
                                ...
                                <div class="password-container">
                                    ...
                                    <input type="password" name="password2" id="password2" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-asfi-blue focus:border-asfi-blue pr-10" placeholder="Confirm Password" required>
                            ...
                            <!-- Submit Button -->
                            <div class="pt-4">
                                <button type="submit" class="w-full bg-asfi-blue text-white py-3 px-4 rounded-md font-medium hover:bg-blue-800 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-asfi-blue signin-btn">
                                    Create Account
                                </button>
  ...
  <?php include '../partials/footer.php'; ?>
    ...
    <!-- Back to Top Button -->
    <button id="scroll-top" class="fixed bottom-6 right-6 bg-asfi-blue text-white p-3 rounded-full shadow-lg hover:bg-blue-800 transition-colors hidden">

...
<head>
	...
	<meta name="description" content="ASFI Research Journal">
	<meta name="author" content="Weperch LLC">
<title> ASFI Research Journal - Update Account</title>
...
<meta http-equiv="Expires" content="0">
	...
	<link rel="stylesheet" href="../../front/public/css/loader.css?v=<?= time(); ?><?= time(); ?>">
...
<body class="header-1 business" id="formNotSubmitted">
    ...
    <div class="overlayX" >    
        <div class="spinn"></div>
       <div style="font-weight: bold; color:black">Please wait...</div>
    </div>
    ...
    <main>
        ...
        <div class="main-submit-container">
            <div class="submission-header">
                ...
                <ul class="submit-nav">
                    <a href=""><li class="active">Account Settings</li></a>
                    <a href="../../dashboard/"><li>Back to Dashboard</li></a>
                    <!-- <a href="../../dashboard/reviewerdash/"><li>Reviewer Dashboard</li></a> -->
                </ul>
            </div>
            <div class="submit-container">
                <div class="submit-body">
                    <form id="registerForm">
                        ...
                        <h3 style="text-align: center;">Update Account Info</h3> <br>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="email" class="bg-grey form-control" placeholder="Email..." name="email" id="email" required readonly style="background-color: rgb(211, 211, 211);">
                        </div>
						...
						<div>
                            ...
                            <input type="text" class="form-control" placeholder="Affiliation..." id="affiliation_country" name="affiliation_country" required>
                        </div>
						<div>
                            <label for="">Affiliation City:</label>
                            <input type="text" class="form-control" placeholder="Affiliation..." id="affiliation_city" name="affiliation_city" required>
                        </div>
                        <div>
                            <label for="">ORCID Id:</label>
                            <input type="text" class="form-control" placeholder="Orcid Id..." name="orcid" id="orcid" >
                        </div>
                        <div>
                            <label for="">ASFI Membership Id:</label>
                            <input type="text" class="form-control" placeholder="Orcid Id..." name="asfi_membership_id" id="asfi_membership_id" >
                        </div>
						<div>
							<label for="discipline">Discipline</label>
							<select id="discipline" name="discipline" class="form-control discipline" required>
                        ...
                        <div>
                            ...
                            <div class="review-option">
                                <span>Yes</span> <input type="radio" id="reviewYes" name="is_available_for_review" value="yes">
                                <span>No</span> <input type="radio" id="reviewNo" name="is_available_for_review" value="no">
                            </div>
                        </div>
                
                        
                        <div style="text-align: center;">
                            <!-- <input type="submit" class="signin-btn" value="Update Account"> -->
                            <button class="signin-btn" >Done</button>
...
<script type="module" src="../../js/forms/updateAccount.js?v=<?= time(); ?>"></script>

...
<script>
    ...
    if(disciplineContainer){
        console.log("DisciplineContainer")
    }else{
        console.log("NOT")
    }
    discipline.addEventListener("change", function() {
        console.log(discipline.value);
        if (discipline.value === "Other") {
            discipline.removeAttribute("name");
            discipline.removeAttribute("required");
            ...
            discipline.setAttribute("required", true);
            ...
            <div class="submit-container">
                <div class="submit-body">
                    <form id="registerForm" enctype="multipart/form-data">
                        ...
                        <div>
                            <label for="field">Editorial Assignment:</label>
							<select name="field" id="field">
								<option value="">Select Editorial Assignment</option>
								<option value="Editor In Chief">Editor in Chief</option>
								<option value="Editors">Editor</option>
								<option value="Editorial Assistants">Editorial Assistants</option>
								<option value="Associate Editors">Associate Editors</option>
								<option value="Sectional Editors">Sectional Editors</option>
							</select>
                            <!-- <input type="text" class="form-control" placeholder="Enter feild of specialization..." name="field" id="field" > -->
                        </div>
                        ...
                        <div>
                            ...
                            <input type="file" accept=".jpeg, .jpg, .png" class="form-control" name="photo" id="photo">
                        </div>
						...
						<div>
                            ...
                            <select id="discipline" name="discipline" class="form-control discipline" >
						...
						<div>
							...
							<input type="text" class="form-control" name="orcid" id="orcid" placeholder="Enter ORCID ID">
						</div>
                        <div>
                            <label for="verifyCode">Verification Code</label>
                            <input type="password" class="form-control" name="verifyCode" id="verifyCode" placeholder="Enter verification Code" required>
                        </div>
                        
                        <input type="submit" class="signin-btn" value="Submit">
                    </form>
                </div>
            </div>
...
<script type="module" src="../../js/forms/addEditor.js?v=<?= time(); ?>"></script>
</body>
</html>
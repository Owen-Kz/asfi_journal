...
<title> ASFI Research Journal - Reset Code</title>
...
<div class="journal-banner">
  <div class="container banner-inner">
        ...
        <div class="main-submit-container">
            ...
            <div class="submit-container">
                <div class="submit-body">
                    <form id="resetPassCode">
                        <h3 style="text-align: center;">Enter Code</h3> <br>
                        <input type="number" class="form-control" placeholder="Enter Code" id="resetCode" required>
    ...
    <script src="../../js/dashboards/resetCode.js?v=<?= time(); ?>" type="module"></script>
    <!-- <script src="../../js/forms/resetPasswordEmail.js?v=<?= time(); ?>" type="module"></script> -->

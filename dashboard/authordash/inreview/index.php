            ...
            <aside class="w-64 bg-white shadow-lg hidden md:block border-r border-gray-100">
                <div class="p-6">
                    <div class="text-center mb-8">
                        <h2 class="text-1xl font-bold text-gray-800">Author Dashboard</h2>
                    </div>
                    
                    <ul class="space-y-2">
                        <li>
                            <a href="../manuscripts/" class="flex items-center px-4 py-3 text-gray-700 hover:bg-purple-50 rounded-lg sidebar-menu-item">
                        ...
                        <li>
                            <a href="" class="flex items-center px-4 py-3 text-white bg-gradient-to-r from-accent to-purple-800 rounded-lg sidebar-menu-item active-menu-item shadow-sm">
                                <span class="inReviewCount mr-3 bg-white text-accent rounded-full w-6 h-6 flex items-center justify-center text-xs font-bold">0</span>
    ...
    <div id="mobileSidebar" class="fixed inset-0 z-40 transform translate-x-full transition-transform duration-300 md:hidden">
        ...
        <div class="relative flex flex-col w-full max-w-xs bg-white h-full">
            ...
            <div class="flex-1 overflow-y-auto py-4 px-4">
                <ul class="space-y-2">
                    <li>
                        <a href="../manuscripts/" class="flex items-center px-4 py-3 text-gray-700 hover:bg-purple-50 rounded-lg">
                            <span class="newSubmissionsCount mr-3 bg-gray-200 text-gray-700 rounded-full w-6 h-6 flex items-center justify-center text-xs font-bold">0</span>
                            <i class="bi bi-send-check mr-3"></i>
                            Submitted Manuscripts
                        </a>

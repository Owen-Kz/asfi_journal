        ...
        <div class="sidebar-menu" id="userMenu">
          <div class="submission-header-dash" style="margin-top: 30px;">
            ...
            <ul class="submit-nav">
              ...
              <li class="active">Submit Corrections
...
<div id="manuscriptIDField" style="display: none;">
    ...
    <input type="text" name="previous_id" id="previous_id" class="form-control"> <br>
</div> 
                    ...
                    <div class="form-section hidden" id="disclosures">
                      ...
                      <div style="display: flex; justify-content: space-around;">
                       ...
                       <div style="display: flex; justify-content: space-between;">
                        <button type="button" name="review_stat" style="margin: 20px; background-color: blueviolet; border: none; padding: 15px 20px 15px 20px; border-radius: 8px; color: white; font-weight: bold; text-align: center;" onclick="setStatus('correction_saved')" hidden> 
                          Save For Later 
                      </button> 

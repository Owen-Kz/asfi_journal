        ...
        <div class="sidebar-menu" id="userMenu">
          <div class="submission-header-dash" style="margin-top: 30px;">
            ...
            <ul class="submit-nav">
              ...
              <li class="active">Submit New Manuscript
    ...
    <input type="text" name="previous_id" id="" class="form-control"> <br>
                      ...
                      <div id="upload-manuscript" class="form-section hidden">
                        <div>
                          ...
                          <input type="file" class="form-control requiredFiles" name="manuscript_file">
                        </div>

                        <div id="coverLetterContainer">
                          <label for=""><span style="color: #e22424;">*</span>Cover Letter:</label>
                          <input type="file" class="form-control requiredFiles" name="cover_letter">
                        </div>
                      ...
                      <div style="display: flex; justify-content: space-around;">
                        ...
                        <!-- next button  -->
                        <button type="button" class="submit-next nextManuscript" onclick="checkRequiredFiles()" disabled>Save & Continue</button>
                        <!-- end next button  -->
                      </div>

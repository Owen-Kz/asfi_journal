        ...
        <div class="sidebar-menu" id="userMenu">
          <div class="submission-header-dash" style="margin-top: 30px;">
            ...
            <ul class="submit-nav">
              ...
              <li class="active">Submit Revision
                <ul class="submit-nav" id="sectionNav">
                  ...
                  <a href="javascript:void(0)" id="upload_manuscript_nav" class="disabled">
                    <li><i class="material-icons">lock</i>Upload Manuscript</li>
                  </a>
                  <a href="javascript:void(0)" id="title_nav" class="disabled">
                    <li><i class="material-icons">lock</i>Title</li>
                  </a>
                  <a href="javascript:void(0)" id="abstract_nav" class="disabled">
                    <li><i class="material-icons">lock</i>Abstract</li>
                  </a>
                  <a href="javascript:void(0)" id="keywords_nav" class="disabled">
                    <li><i class="material-icons">lock</i>Keywords</li>
                  </a>
                  <a href="javascript:void(0)" id="author_information_nav" class="disabled">
                    <li><i class="material-icons">lock</i>Authors</li>
                  </a>
                  <a href="javascript:void(0)" id="suggest_reviewers_nav" class="disabled">
                    <li><i class="material-icons">lock</i>Suggest Reviewers</li>
                  </a>
                  <a href="javascript:void(0)" id="disclosures_nav" class="disabled">
                    <li><i class="material-icons">lock</i>Disclosures</li>
                  </a>
                  <a href="javascript:void(0)" id="review_submit_nav" class="disabled ">
                  ...
                  <div class="submit-body">
                    ...
                    <form id="uploadForm">
                      ...
                      <div id="article-type" class="form-section">
                        ...
                        <label for=""><span style="color: #e22424;">*</span>Has this manuscript been submitted previously to ASFIRJ?</label>  <br>
...
<p style="color: #e22424;">* Indicates Mandatory Fields</p>
                      ...
                      <div id="title" class="form-section hidden">
                        ...
                        <div style="display: flex; justify-content: space-around;">
                          ...
                          <!-- next button  -->
                          <button type="button" class="submit-next nextManuscript" onclick="showNext('abstract', 'title', 'title_nav', 'abstract_nav', 'upload-manuscript', 3,3)" disabled>Save & Continue</button>
                          <!-- end next button  -->
                        </div>
                      ...
                      <div id="abstract" class="form-section hidden">
                        ...
                        <div style="display: flex; justify-content: space-around;">
                          ...
                          <!-- next button  -->
                          <button type="button" class="submit-next nextManuscript" onclick="showNext('keywords', 'abstract', 'abstract_nav', 'keywords_nav', 'title', 4,4)" disabled>Save & Continue</button>
                          <!-- end next button  -->
                        </div>
                      </div>
                    ...
                    <div id="author-information" class="form-section hidden">
                      ...
                      <div id="addAuthor" style="width: 100%;">
                        <div class="authorinfoContainer">
                          ...
                          <div class="authorinfo">
                            <div style="margin-right: 10px;">
                                ...
                                <input type="text" class="form-control hd" placeholder="ORCID ID..." name="loggedIn_authors_ORCID" id="loggedIn_orcid">
                            </div>
                        

                            <div style="margin-right: 10px;">
                              <label for=""><span style="color: #e22424;">*</span>Affiliation(s):</label>
                              <input type="text" class="form-control hd" placeholder="Affiliation..." name="loggedIn_affiliation" id="loggedIn_affiliation" style="margin-right: 5px;" readonly>
                          </div>
                          <div style="margin-right: 10px;">
                            <label for=""><span style="color: #e22424;">*</span>City:</label>
                            <input type="text" class="form-control hd" placeholder="City..." name="loggedIn_affiliation_city" id="loggedIn_affiliation_city" style="margin-right: 5px;" readonly>
                          </div>
                          <div style="margin-right: 10px;">
                            <label for=""><span style="color: #e22424;">*</span>Country:</label>
                            <input type="text" class="form-control" placeholder="Country..." name="loggedIn_affiliation_country" id="loggedIn_affiliation_country" style="margin-right: 5px;" readonly>
                          </div>
                        </div>
                        <div>
                          <label for=""><span style="color: #e22424;">*</span>Email:</label>
                          <input type="text" class="form-control hd" placeholder="Email..." name="loggedIn_author" id="logged_email" readonly>
                        </div>
                        <div>
                          ...
                          <div>
                              ...
                              <input type="text" class="form-control hd" placeholder="Corresponding Author Email..." name="corresponding_author" id="loggedIn_email">
                          </div>
                        </div>
                         <br>
                      </div>
                        ...
                        <div style="display: flex; justify-content: space-around;">
                          ...
                          <!-- next button  -->
                          <button type="button" class="submit-next nextManuscript" onclick="showNext('suggest-reviewers', 'author-information', 'author_information_nav', 'suggest_reviewers_nav', 'keywords', 6,6)" disabled>Save & Continue</button>
                          <!-- end next button  -->
                        </div>  
                    </div>
                    ...
                    <div class="form-section hidden" id="disclosures">
                      ...
                      <div style="display: flex; justify-content: space-around;">
                        ...
                        <button type="button" name="review_stat" style="margin: 20px; background-color: blueviolet; border: none; padding: 15px 20px 15px 20px; border-radius: 8px; color: white; font-weight: bold; text-align: center;" onclick="setStatus('revision_saved')" hidden> 
                            Save For Later
                        </button>
                        <button style="border: none; background-color: transparent;">or</button>
                        <button type="button" name="review_stat" style="margin: 20px; background-color: blueviolet; border: none; padding: 15px 20px 15px 20px; border-radius: 8px; color: white; font-weight: bold;" onclick="setStatus('revision_submitted')" hidden>
                            Submit
                        </button>
...
function closeModal() {
  ...
  closeModal();
    ...
    <script src="../../../js/forms/uploadRevision.js?v=<?= time(); ?>" type="module"></script>

    ...
    <main>
        ...
        <div class="main-submit-container">
            <div class="submission-header">
                ...
                <ul class="submit-nav">
                    <a href=""><li class="active">SignUp</li></a>
                    <a href="./submitManuscriptSignIn.html"><li>SignIn</li></a>
                </ul>
            </div>
            <div class="submit-container">
                <div class="submit-body">
                    <form action="" id="registerForm">
                            ...
                            <select name="prefix" id="prefix" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 text-gray-700 text-sm" required>
                                <option value="">Select Preferred Prefix</option>
                        ...
                        <div>
                            ...
                            <input type="text" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 text-gray-700 text-sm" placeholder="First Name..." name="first_name" id="first_name">
                        </div>

                        <div>
                            <label for="">Last Name:</label>
                            <input type="text" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 text-gray-700 text-sm" placeholder="Last Name..." name="last_name" id="last_name">
                        </div>

                        <div>
                            <label for="">Other Name:</label>
                            <input type="text" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 text-gray-700 text-sm" placeholder="Other Name..." name="other_name" id="other_name">
                        </div>

                        <div>
                            <label for="">Email</label>
                            <input type="text" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 text-gray-700 text-sm" placeholder="Email..." name="email" id="email">
                        </div>
                        
                        <div>
                            <label for="">Affiliation:</label>
                            <input type="text" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 text-gray-700 text-sm" placeholder="Affiliation...">
                        </div>

                        <div>
                            <p>Are you available to review for ASFIRJ? (optional)</p>
                            <div class="review-option">
                                <span>Yes</span> <input type="radio" id="reviewYes" name="review" value="yes">
                                <span>No</span> <input type="radio" id="reviewNo" name="review" value="no">
                            </div>
                        </div>
                        <div>
                            <label for="">Create Password:</label>
                            <input type="password" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 text-gray-700 text-sm" placeholder="Create Password..." name="password" id="password">
                        </div>
                        <div>
                            <label for="">Confirm Password:</label>
                            <input type="password" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 text-gray-700 text-sm" placeholder="Confirm Password..." name="password2" id="password2">
                        </div>
            ...
            <div class="submit-research-container">
                <h4 class="sub-head">PUBLISH YOUR RESEARCH</h4>
                <div class="submit-research">
                    <div class="sub-manuscript">
                        <a href=""><button type="button">Submit Manuscript</button></a>
                    </div>
                </div>
